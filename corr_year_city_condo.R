...
p1 <- ggplot(year2012, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2012") +
  ylab("City") +
  labs(color = "2-Bedroom Apartment Growth Rate (%)")
p2 <- ggplot(year2013, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2013") +
  ylab("City")
p3 <- ggplot(year2014, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2014") +
  ylab("City")
p4 <- ggplot(year2015, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2015") +
  ylab("City")
p5 <- ggplot(year2016, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2016") +
  ylab("City")
p6 <- ggplot(year2017, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2017") +
  ylab("City")
p7 <- ggplot(year2018, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2018") +
  ylab("City")
p8 <- ggplot(year2019, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2019") +
  ylab("City")
p9 <- ggplot(year2020, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2020") +
  ylab("City")
p10 <- ggplot(year2021, aes(month, cityname, fill = conrate)) +
  geom_tile(colour = "white") +
  scale_fill_gradient(low = "#f7fcf0", high = "#084081") +
  xlab("Year=2021") +
  ylab("City")
...
pt <- annotate_figure(pt,
  top = text_grob("Average Price for Condo Growth Rates: 2012-2021", size = 14)
)
pt
ggsave("condo.png", pt, width = 800, height = 500, limitsize = FALSE)
